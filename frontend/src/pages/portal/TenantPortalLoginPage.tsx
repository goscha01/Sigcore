...
export default function TenantPortalLoginPage() {
  ...
  const { login, loading, error, clearError, isAuthenticated, loadFromStorage } = useTenantAuthStore();
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Sign in with your API key to access your account
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Your API key was provided by your platform administrator
              </p>
            </div>
